...
function isLogin(req, res, next) {
  ...
  router.get("/", isLogin, (req, res) => {
    res.render("Admin/GroupProduct/addgroupProduct", { groupProduct: {} });
  });
  ...
  router.post("/", isLogin, urlencodedParse, [
    ...
    if(!errors.isEmpty()){
      ...
      res.render("Admin/GroupProduct/addgroupProduct", { groupProduct: {} , alert});
    } else {
      let sql = "INSERT INTO group_product SET ?";
      let params = req.body;
